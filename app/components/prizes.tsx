...
export default function Prize() {
  return (
    <div
      id="prize"
      className="flex flex-col sm:mt-40 mt-20 bg-black items-center justify-center font-sans mb-44 sm:max-w-5xl md:max-w-3xl"
    >
      <div
      ...
      <div className="w-full md:min-w-[1200px] max-w-[280px]">
