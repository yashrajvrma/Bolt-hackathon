...
const badgeVariants = cva(
  "inline-flex items-center justify-center rounded-full border sm:px-4 px-3 sm:py-1 py-1 text-xs font-light leading-normal transition-colors outline-offset-2 focus-visible:outline focus-visible:outline-2 focus-visible:outline-ring/70 backdrop-blur-lg bg-opacity-30",
  {
    variants: {
      variant: {
        default:
